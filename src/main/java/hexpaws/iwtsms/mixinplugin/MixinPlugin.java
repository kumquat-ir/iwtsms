...
import hexpaws.iwtsms.IWTSMS;
import hexpaws.iwtsms.Tags;
...
import static hexpaws.iwtsms.mixinplugin.TargetedMod.VANILLA;
import static java.nio.file.Files.walk;

// would have preferred to use mixin late loading instead of this bullshit but that didnt work so here we fucking are
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    public List<String> getMixins() {
        Config.synchronizeConfiguration(Config.cfgFile);
        IWTSMS.printInfo();
