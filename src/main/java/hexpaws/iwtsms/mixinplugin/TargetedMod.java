...
public enum TargetedMod {
    ...
    ADVENTUREBACKPACK("Adventure Backpack", "adventurebackpack", true),
    GALACTICRAFT("Galacticraft Core", "Galacticraft", true),
    TRAVELLERSGEAR("Traveller's Gear", "TravellersGear", true);
